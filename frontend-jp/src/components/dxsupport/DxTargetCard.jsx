...
const DxTargetCard = ({title,image,description}) => {
    return (
        <div className="dx-target-card px-[37px] pt-8 pb-[50px] bg-white rounded-[27px]">
            <h3 className="text-[#02021E] text-center text-[20px] md:text-[18px] lg:text-[20px] font-bold leading-[28px] lg:leading-[34px] tracking-[-2%]">{title}</h3>
