...
const Onboarding = () => {
    ...
    return (
        <div className="bg-white">
            <div className="max-w-[1366px] mx-auto pt-[120px] lg:pt-[209px] pb-[33px] px-[24px] lg:px-[64px]">
                <div className="overflow-hidden">
                    <div ref={titleRef}>
                        <SectionTitle jp="導入の流れ" eng="onboarding process" />
                    </div>
                </div>
                <div ref={containerRef} className="mt-[90px] grid grid-cols-1 lg:grid-cols-3 gap-x-[35px] gap-y-[52px]">
                    <OnboardingCard
                        step="1"
                        title="お問い合わせ／お打ち合わせ"
                        image={Img1}
