...
const UseCase = () => {
    ...
    return (
        <div className="bg-[#1E2C44]">
            <div className="max-w-[1366px] mx-auto px-[24px] xl:px-[121px] py-[80px] lg:py-[140px]">
                <div className="overflow-hidden">
                    <div ref={titleRef}>
                        <SectionTitle jp="参考導入例" eng="sample use cases" jpcolor="text-white" engcolor="text-white" />
                    </div>
                </div>
                <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-3 gap-[20px] md:gap-2 lg:gap-[20px] mt-[50px] lg:mt-[60px]">
                    <UseCaseCard
                    ...
                    <UseCaseCard
                        ...
                        image={Img2}
                        text1="構成：エンジニア2名、デザイナー1名、当社担当（伴走型）"
                    ...
                    <UseCaseCard
                        ...
                        image={Img3}
                        text1="構成：エンジニア3名、デザイナー1名、QAサポート1名"
                        text2="プラン：安心ラボ型EOR"
