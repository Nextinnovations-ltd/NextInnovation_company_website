        ...
        <div className="bg-white rounded-b-[80px]">
            <div className="max-w-[1366px] mx-auto px-[64px] pb-[137px]">
                ...
                <div className="flex mt-[68px]">
                    ...
                    <div className="w-[407px] shadow-[0px_3px_21px_4px_#1E2C441A] rounded-l-[20px] pb-[50px] mt-[97px]">
                        <div className="text-white bg-[#1E2C44] flex flex-col gap-[10px] items-center rounded-tl-[20px] py-[25px]">
                            ...
                            <p className="text-[15px] font-medium leading-[28px] tracking-[3%]">最低3ヶ月〜、1名から利用可能</p>
                        </div>
                        ...
                        <div className="ps-[45px] pe-[61px]">
                            <Link to="">
                                <div className="text-[18px] text-[#F15A29] font-bold leading-[30px] tracking-[3%] py-[14px] px-[58px] border-[2px] border-[#F15A29] rounded-[40px]">このプランで相談する</div>
                            </Link>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="w-[424px] shadow-[0px_3px_21px_4px_#1E2C441A] border-[10px] border-[#F15A29] rounded-t-[20px] pb-[84px]">
                            <div className="text-white bg-[#F15A29] relative">
                                <img src={Crown} alt="" className="mx-auto absolute top-[-20px] left-1/2 -translate-x-1/2" />
                                <div className="flex flex-col gap-[10px] items-center pb-[25px] pt-[64px]">
                                    ...
                                    <p className="text-[15px] font-medium leading-[28px] tracking-[3%]">最低12ヶ月〜、1名から利用可能</p>
                                </div>
                            </div>
                            ...
                            <div className="ms-[45px] me-[58px]">
                                <Link to="">
                                    <div className="bg-[#F15A29] text-[18px] text-white font-bold leading-[30px] tracking-[3%] py-[14px] px-[58px] border-[2px] border-[#F15A29] rounded-[40px]">このプランで相談する</div>
                                </Link>
                            </div>
                    ...
                    <div className="w-[407px] shadow-[0px_3px_21px_4px_#1E2C441A] rounded-r-[20px] pb-[50px] mt-[97px]">
                        <div className="text-white bg-[#1E2C44] flex flex-col gap-[10px] items-center rounded-tr-[20px] py-[25px]">
                            ...
                            <p className="text-[15px] font-medium leading-[28px] tracking-[3%]">最低6ヶ月〜、3名から利用可能</p>
                        </div>
