...
const Navbar = () => {
    return (
        <div className="text-[#444444] bg-white flex justify-between items-center py-[18px] px-[32px]">
            <div>
                <h2 className="chillax text-[20px] md:text-[32px] font-medium md:font-semibold leading-[100%] tracking-[-4%]">Next Innovations</h2>
            </div>
