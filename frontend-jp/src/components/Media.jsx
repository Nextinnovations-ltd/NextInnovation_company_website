...
const Media = () => {
    ...
    return (
        <div className="bg-[#F7F7F7] z-0" id="yutasan-section">
            <div className="max-w-[1126px] mx-auto pt-[59px] pb-[80px] lg:pt-[140px] lg:pb-[350px] px-6 xl:px-0">
                <div className="overflow-hidden">
                    <div ref={titleRef}>
                        <SectionTitle jp="メディア" eng="Media" />
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[34px] mt-[50px]">
                    <div ref={blogRef} className="!z-[999] pt-[27px] pb-[15px] ps-[22px] pe-[30px] xl:pt-[50px] xl:pb-[50px] xl:ps-[41px] xl:pe-[57px] bg-[#F15A29] rounded-[12px] text-white shadow-md">
                        <div className="flex justify-between mb-[40px] lg:mb-[36px] md:min-h-[240px] lg:min-h-[310px]">
                            <div>
                                <h3 className="text-[18px] lg:text-[20px] font-bold leading-[34px] tracking-[-2%] mb-[18px] lg:mb-[24px]">ミャンマー人材<br className="lg:hidden"/>活用ナビ</h3>
                                <p className="text-[12px] lg:text-[13px] w-[130px] lg:w-full font-normal leading-[20px] lg:leading-[28px] tracking-[0%]">採用・EOR・リモート開発の最新情報<br className="hidden lg:block" />をお届けしています。</p>
                            </div>
                            <div className="w-[130px] lg:w-[179px]">
                                <img src={Blog} alt="" />
                            </div>
                        </div>
                    ...
                    <div ref={noteRef} className="ps-[22px] pe-[22px] py-6 xl:py-[50px] xl:ps-[41px] xl:pe-[33px] bg-white rounded-[12px] text-white shadow-md z-[20]">
                        <div className="flex flex-col gap-[5px] lg:gap-0 lg:flex-row lg:justify-between mb-6 lg:mb-[36px]">
                            <div className="lg:w-[278px]">
                                <h3 className="text-[#F15A29] text-[18px] lg:text-[20px] font-bold leading-[34px] tracking-[-2%] mb-[10px] lg:mb-[24px]">ミャンマーで生きる<br/>独身IT社長日記</h3>
                                <p className="lg:w-[252px] text-[12px] text-[#444444] lg:text-[13px] font-normal leading-[21px] lg:leading-[28px] tracking-[0%]">
                            ...
                            <div className="flex justify-center items-center">
                                <img src={Note} alt="" className="w-[107px] lg:w-[130px] xl:w-[191px] shadow-[0_3px_21px_#1E2C441A]" />
                            </div>
                        </div>
                        <div className="flex justify-center">
