...
const Media = () => {
    ...
    return (
        <div className="bg-[#F7F7F7] z-0" id="yutasan-section">
            <div className="max-w-[1126px] mx-auto pt-[59px] pb-[80px] lg:pt-[140px] lg:pb-[350px] px-6 lg:px-0">
                <div className="overflow-hidden">
                    <div ref={titleRef}>
                        <SectionTitle jp="メディア" eng="Media" />
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[34px] mt-[50px]">
                    <div ref={blogRef} className="!z-[999] pt-[27px] pb-[15px] ps-[22px] pe-[30px] lg:pt-[50px] lg:pb-[50px] lg:ps-[41px] lg:pe-[57px] bg-[#F15A29] rounded-[12px] text-white shadow-md">
                        <div className="flex justify-between mb-[40px] lg:mb-[36px] lg:min-h-[310px]">
                            <div>
                    ...
                    <div ref={noteRef} className="ps-[22px] pe-[22px] py-6 lg:py-[50px] lg:ps-[41px] lg:pe-[33px] bg-white rounded-[12px] text-white shadow-md z-[20]">
                        <div className="flex flex-col gap-[5px] lg:gap-0 lg:flex-row lg:justify-between mb-6 lg:mb-[36px]">
                            ...
                            <div className="flex justify-center items-center">
                                <img src={Note} alt="" className="w-[107px] lg:w-[191px] shadow-[0_3px_21px_#1E2C441A]" />
                            </div>
                        </div>
                        <div className="flex justify-center">
