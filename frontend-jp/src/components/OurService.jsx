...
const OurService = () => {
	...
	return (
		<div className="bg-white">
			<div className="our-services max-w-[1126px] mx-auto pt-[89px] lg:pt-[199px] pb-[85px] lg:pb-[180px] gap-12 flex flex-col px-[25px] xl:px-0">
						...
						<Link to="/eor">
							<div className="link-container flex justify-between items-center py-6 lg:py-10 border-t-[2px] border-[#444444]">
								<div className="link-title gap-3 flex flex-col">
									...
									<p ref={addToRefs} className="text-[12px] lg:text-[14px] text-[#444444] font-normal leading-[18px] lg:leading-[31px] tracking-[0%]">勤怠管理・福利厚生・現場サポート込みで、海外<br className="block md:hidden" />人材を“チーム”として定着・活躍させます。</p>
								</div>
						...
						<Link to="/eor">
							<div className="link-container flex justify-between items-center py-6 lg:py-10">
								<div className="link-title gap-3 flex flex-col">
									...
									<p ref={addToRefs} className="text-[12px] lg:text-[14px] text-[#444444] font-normal leading-[18px] lg:leading-[31px] tracking-[0%]">専任PMが進捗・品質を管理。オフショア開発の<br className="block md:hidden" />課題を解決し、成果創出まで伴走。</p>
								</div>
								<div className="" style={{ overflow: 'hidden' }}>
									<img src={RightArrow} alt="" />
								</div>
						...
						<Link to="/development">
							<div className="link-container flex justify-between items-center py-6 lg:py-10">
								<div className="link-title gap-3 flex flex-col">
									...
									<p ref={addToRefs} className="text-[12px] lg:text-[14px] text-[#444444] font-normal leading-[18px] lg:leading-[31px] tracking-[0%]">Web開発・クロスプラットフォーム開発など柔軟に<br className="block md:hidden" />対応。日本案件経験豊富なエンジニアが担当。</p>
								</div>
								<div className="" style={{ overflow: 'hidden' }}>
									<img src={RightArrow} alt="" />
								</div>
						...
						<Link to="/uiux">
							<div className="link-container flex justify-between items-center py-6 lg:py-10">
								<div className="link-title gap-3 flex flex-col">
									...
									<p ref={addToRefs} className="text-[12px] lg:text-[14px] text-[#444444] font-normal leading-[18px] lg:leading-[31px] tracking-[0%]">Figmaを用いた最新のデザイン。コストを抑えつつ<br className="block md:hidden" />高品質なUI/UXを実現。</p>
								</div>
								<div className="" style={{ overflow: 'hidden' }}>
									<img src={RightArrow} alt="" />
								</div>
