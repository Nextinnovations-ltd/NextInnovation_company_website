...
const GoButton = ({name,nameNext="",bgColor="bg-[#F15A29]",bgHoverColor="hover:bg-[#D95125]",link,target="",arrow=RightArrow,textColor="text-white",textHoverColor="text-white"}) => {
    return (
        <Link to={link} target={target} className="">
            <button className={`${bgColor} ${bgHoverColor} ${textColor} ${textHoverColor} group w-[192px] lg:w-[254px] h-[52px] lg:h-[68px] px-[25px] lg:px-[30px] rounded-[40px] text-[12px] lg:text-[16px] font-bold leading-[17px] lg:leading-[20px] tracking-[0%]`}>
