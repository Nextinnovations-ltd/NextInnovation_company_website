...
const WhatWeDo = () => {
    ...
    return (
        <div className="bg-white pt-[376px]">
            <div style={{background: `url(${Earth})`, backgroundPosition: '110% 0%', backgroundRepeat: 'no-repeat'}}>
                <div className="max-w-[1238px] mx-auto text-[#444444]">
                    <div className="overflow-hidden">
                        <div ref={titleRef}>
                            <SectionTitle jp="私たちだからできること" eng="WHAT WE DO" />
                        </div>
                    </div>
                    <div ref={textContainer} className="max-w-[679px] text-[21px] font-normal leading-[34px] tracking=[0%] mt-[50px]">
                        <p>
