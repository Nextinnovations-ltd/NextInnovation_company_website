...
const CompanyProfile = () => {
  ...
  <div className="pt-[50vh] max-w-[1071px] mx-auto relative z-[100] ">
           <div className="" >
                     ...
                     <h1 className='mt-[10px] text-[#444] text-[58px] font-[700] leading-[67px] tracking-[-0.58px] uppercase'>Profile</h1>
          ...
          <div className="border-solid border-b border-b-[#D0D8E6] flex gap-[65px] itmes-center max-w-[1071px] mt-[157px] pb-12">
              <p className='text-[#444] text-[16px] font-[500] leading-[31px]'>
                  会社名
              </p>
              <p className='text-[#000] text-[16px] font-[500] leading-[31px]'> Next Innovations株式会社</p>
          </div>
          <div className="border-solid border-b border-b-[#D0D8E6] flex gap-[33px] itmes-center max-w-[1071px] pt-12 pb-12">
              <p className='text-[#444] text-[16px] font-[500] leading-[31px]'>
                設立年月日
              </p>
              <p className='text-[#000] text-[16px] font-[500] leading-[31px]'>  2020年1月1日</p>
          </div>
          <div className="border-solid border-b border-b-[#D0D8E6] flex gap-[65px] itmes-center max-w-[1071px] pt-12 pb-12">
              <p className='text-[#444] text-[16px] font-[500] leading-[31px]'>
                代表取締役
              </p>
              <p className='text-[#000] text-[16px] font-[500] leading-[31px]'>  YUTA MUKAI</p>
          </div>
          <div className="border-solid border-b border-b-[#D0D8E6] flex gap-[65px] itmes-center max-w-[1071px] pt-12 pb-12">
              <p className='text-[#444] text-[16px] font-[500] leading-[31px]'>
                  会社名
          ...
          <div className=" max-w-[1071px] pt-12  pb-12 border-solid border-b border-b-[#D0D8E6] ">
             <div className="flex gap-[65px] itmes-center">
                 <p className='text-[#444] text-[16px] font-[500] leading-[31px]'>
                    事業所
                  </p>
                   <div className="flex flex-col gap-4">
                     <p className='text-[#000] text-[16px] font-[500] leading-[31px] max-w-[779px]'> 部屋番号 (602)、ガンダマール レジデンス、ガンダマール ロード、マヤンゴン タウンシップ、ヤンゴン、ミャンマー</p>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.2992396049367!2d96.158037!3d16.861085499999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1933ef77e5147%3A0x2a6d94f48d039f50!2sNext%20Innovations%20co.%2C%20Ltd!5e0!3m2!1sen!2smm!4v1758691698063!5m2!1sen!2smm" width="100%" height="519"  style={{ border: 0 }} className='max-w-[923px] self-end' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                   </div>
         
             </div>
        
          </div>
               <div className="border-solid border-b border-b-[#D0D8E6] flex gap-[24px] itmes-center max-w-[1071px] pt-12 pb-12">
                  <p className='text-[#444] text-[16px] font-[500] leading-[31px]'>
                    会社概要
                  </p>
                  <p className='text-[#000] text-[16px] font-[500] leading-[31px] max-w-[891px]'>私たちNext Innovationsは、ミャンマーに拠点を置く日本企業であり、IT分野に特化しています。  プロフェッショナルなチームと多くのお客様に支えられ、高品質で革新的なウェブデザイン、ウェブマーケティング、映像制作サービスを提供しています。  当社は2020年に向井優太氏の出資により設立され、これまでに国内外および日本で2,000以上のブランドに携わってまいりました。  IT分野でNo.1の企業となり、一人ひとりのお客様にご満足いただけることを目指しています</p>
              </div>
