                                        ...
                                        <div className="space-y-[24px]">
                                            ...
                                            <div>
                                                <textarea id="message" rows="4" 
                                                    ...
                                                    placeholder:font-normal focus:outline-none`} placeholder="お問い合わせ内容詳細"
                                            ...
                                            <div className="flex items-center mb-5">
                                                ...
                                                <label htmlFor="terms" className="ms-2 text-[16px] font-medium text-gray-900"><Link to="/privacy" className="text-blue-600 hover:underline">プライバシーポリシー</Link>に同意する</label>
                                            </div>
                                        </div>
