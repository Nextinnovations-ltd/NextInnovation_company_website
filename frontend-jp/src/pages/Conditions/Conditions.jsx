...
<div className='bg-[#1E2C44]'>
    <div className="relative w-full bg-white rounded-b-[40px] lg:rounded-b-[80px] overflow-hidden">
        ...
        {/* Content */}
        <div className="max-w-[1120px] mx-auto px-[24px] md:px-[145px] pt-[108px] md:pt-[114px] pb-[180px] relative z-10">
            ...
            <motion.p initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                viewport={{ once: true }} className="max-w-[1120px] text-[#444] text-[14px] md:text-[20px] leading-[29px] md:leading-[38px] font-[500]">
            ...
            <motion.p initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                viewport={{ once: true }} className="max-w-[1120px] text-[#444] text-[14px] md:text-[20px] leading-[29px] md:leading-[38px] font-[500] mt-[22px]">
      ...
      <motion.p initial={{ opacity: 0, y: 30 }}
        ...
         当社は、ユーザーの依頼に基づき、雇用代行業務を提供する。 
            ...
            <motion.p initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                viewport={{ once: true }} className="mt-[12px] md:mt-[20px] text-[#444] text-[14px] md:text-[20px] font-[500] leading-[28px] md:leading-[38px] mb-[8px] md:mb-[30px] max-w-[1120px]">
              ...
              <div className="mt-[12px] md:mt-[20px] flex gap-[11px] items-start mb-[8px] md:mb-[12px]">
                     <div className="bg-[#096FCA] min-w-[10px] min-h-[10px] rounded-full mt-3.5"></div>
                        ...
                        <motion.p initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.8, ease: "easeOut" }}
                            viewport={{ once: true }} className="mt-[12px] md:mt-[20px] text-[#444] text-[14px] md:text-[20px] font-[500] leading-[28px] md:leading-[38px] mb-[12px] md:mb-[20px] max-w-[1120px]">
            ...
            <motion.p initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                viewport={{ once: true }} className="mt-[12px] md:mt-[20px] text-[#444] text-[14px] md:text-[20px] font-[500] leading-[28px] md:leading-[38px] max-w-[1120px]">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }}
             ...
             <motion.p initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                viewport={{ once: true }} className="mt-[12px] md:mt-[20px] text-[#096FCA] text-[14px] md:text-[20px] font-[500] leading-[28px] md:leading-[38px] max-w-[1120px]">
