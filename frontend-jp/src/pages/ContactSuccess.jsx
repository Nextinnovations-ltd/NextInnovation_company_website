		...
		<>
			<div className="contact relative">
				<div className="!bg-cover !bg-no-repeat bg-[url('/images/contact-bg.png')]">
					<div className="max-w-[1366px] mx-auto px-6 lg:px-[64px] pt-[100px] pb-[116px] lg:pb-[150px] text-[#444444]">
						...
						<div className="mt-[51px] lg:flex lg:justify-between">
							...
							{!!message && (
								<div className="md:w-[505px] lg:w-[400px] xl:w-[505px] mt-[52px] lg:mt-0">
									<div className='flex flex-col items-center'>
										<h3 ref={addToRefs} className="text-[20px] md:text-[24px] text-[#1A1A1A] font-semibold leading-[30px] tracking-[-0.48px] uppercase ">ご連絡ありがとうございました！</h3>
										...
										<Link to="/" className="flex items-center justify-center w-full bg-[#E84721] text-[#FFF] py-[16px] md:py-[20px] text-[16px] md:text-[20px] font-semibold rounded-[40px]">
											ホームページへ
										</Link>
									</div>
								</div>
