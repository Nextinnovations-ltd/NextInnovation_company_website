  ...
  return (
   <div className='w-full bg-white pb-[100px] md:pb-[160px] rounded-[40px] md:rounded-[80px] relative px-6'>
     <div className='max-w-[1120px] mx-auto '>
      ...
      <motion.div 
        className="hidden md:flex gap-2 items-center mt-[150px] mb-[46px]"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeUp}
      ...
      >
        <div className="">
          <motion.h1 variants={fadeUp} className='text-[#444] text-[16px] md:text-[28px] font-[700] leading-[-0.32px] md:leading-[-0.56px] max-w-[480px]'>
            お客様に忘れられないブランド体験と
            高価値なウェブサイトを提供します
          </motion.h1>
          <div className="flex flex-col gap-3 md:gap-5 max-w-[558px] mt-[24px] md:mt-[50px]">
            ...
            <motion.p variants={fadeUp} className='text-[#444] text-[12px] md:text-[14px] font-[400] leading-[22px] md:leading-[31px]  max-w-[480px]'>
        ...
        <motion.img 
          src={Yutasan} 
          alt="" 
          className='w-[100%] md:w-[420px] h-[500px] rounded-[16px] object-cover object-top'
          variants={fadeUp}
        />
      </motion.div>

      <motion.div 
        className="mt-[118px] md:mt-[177px]"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeUp}
      ...
      <motion.h1 
        className='text-[#444] text-[32px] font-[700] leading-[50px] md:leading-[40px] tracking-[-0.32px] uppercase mt-2 md:mt-[10px]'
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeUp}
