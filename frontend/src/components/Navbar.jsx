            ...
            <div className={`mobile-navbar ${isMobileMenuOpen ? "open" : ""}`}>
                <ul>
                    <li onClick={() => handleNavLinkClick("/")}>
                        <button className={path == '/' ? 'active' : ''} >Home</button>
                    </li>
                    <li onClick={() => handleNavLinkClick("/about-us")}>
                        <button className={path == '/about-us' ? 'active' : ''} >About</button>
                    </li>
                    <li>
                    ...
                    <li onClick={() => handleNavLinkClick("/news")}>
                        <button className={path == '/news' ? 'active' : ''}>News</button>
                    </li>
                    <li onClick={() => handleNavLinkClick("/works")}>
                        <button className={path == '/works' ? 'active' : ''}>Our Works</button>
                    </li>
                    <li onClick={() => handleNavLinkClick("/contact")}>
                        <button className={path == '/contact' ? 'active' : ''}>Contact</button>
                    </li>
                    {/* <li>
                        <LanguageDropdown/>
                    </li> */}
