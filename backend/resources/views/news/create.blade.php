<x-layout>
    ...
    <div class="grid grid-cols-5 gap-4">
        <div class="col-span-5 xl:col-span-3 p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8">
            <h5 class="text-2xl font-medium text-gray-900 dark:text-white mb-6">Create News</h5>
            <form class="space-y-6" action="{{ route('news.store') }}" method="POST">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <x-forms.select name="category">
                        <x-forms.option name="category" value="1" text="News" />
                        <x-forms.option name="category" value="2" text="Career" />
                        <x-forms.option name="category" value="3" text="Blog" />
                    </x-forms.select>
                    <x-forms.error name="category" />
                </div>
                <div>
                    <x-forms.label for="feature" text="Feature Image" require="*" />
                    <x-forms.input type="hidden" name="feature" id="hidden-feature" />
                    <x-forms.disabled type="text" name="feature" id="feature" />
        ...
        <div class="col-span-5 xl:col-span-2">
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                <form action="{{ route('news.create.image') }}" id="myForm" class="space-y-6" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
