    ...
    <div style="padding-left: 20px;">
        <p>
            ...
            <span class="desktop-link">
                <a href="https://mail.google.com/mail/?view=cm&to=info@next-innovations.ltd">info@next-innovations.ltd</a>
            </span>
            <span class="mobile-link">
                <a href="mailto:info@next-innovations.ltd" target="__blank">info@next-innovations.ltd</a>
            </span>
            まで直接ご連絡ください。
        </p>
        ...
        <p>
            ・
            <a href="https://jp.next-innovations.ltd/eor">EORサービスページ</a>
        </p>
        <p>
            ・
            <a href="https://jp.next-innovations.ltd/dx-support">DX支援サービスページ</a>
        </p>
    </div>
    <p style="color: black;">Next Innovations</p>
    <a href="https://jp.next-innovations.ltd">https://jp.next-innovations.ltd</a>
    <div style="padding-left: 20px;">
        <p>さらに弊社を知っていただけるコンテンツもぜひご覧ください：</p>
        <p><a href="https://demo-site.next-innovations.ltd/ni-blog">会社公式ブログはこちら</a></p>
        <a href="https://note.com/yuta_myanmar_eor">代表ブログはこちら</a>
    </div>
