        ...
        <div class="p-8 rounded-lg flex items-center h-screen">
            <div class="w-[500px] mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8">
                ...
                <form class="space-y-6" action="{{ route('resetPassword', $token) }}" method="POST">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center">Reset Password</button>
                </form>
            </div>
        </div>
    </div>
